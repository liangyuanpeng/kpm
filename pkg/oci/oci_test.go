...
func TestLogin(t *testing.T) {
	...
	assert.Equal(t, err.Error(), "failed to login 'ghcr.io', please check registry, username and password is valid\n failed to validate the credentials for ghcr.io: Get \"https://ghcr.io/token?scope=repository%3Auser%2Fimage%3Apull&service=ghcr.io\": response status code 403: denied: denied\n")
}
